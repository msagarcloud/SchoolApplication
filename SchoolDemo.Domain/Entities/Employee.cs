...
public class Employee
{
    ...
    public PaymentModeMaster? PaymentMode { get; set; }
    public EmpTypeMaster? EmployeeType { get; set; }
    public CategoryMaster? Category { get; set; }
    public GenderMaster? Gender { get; set; }
    public BloodGroupMaster? BloodGroup { get; set; }
    public GradeMaster? Grade { get; set; }
    public City? CurrentCity { get; set; }
    public State? CurrentState { get; set; }
    public Country? CurrentCountry { get; set; }
    public City? PermanentCity { get; set; }
