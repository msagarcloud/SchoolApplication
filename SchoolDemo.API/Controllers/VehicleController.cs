...
public class VehicleController : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] VehicleRequest request)
    {
        ...
        {
            return StatusCode(500, $"An error occurred while creating vehicle: {ex.Message}");
        }
    }
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] VehicleRequest request)
    {
        ...
        {
            return StatusCode(500, $"An error occurred while updating vehicle: {ex.Message}");
        }
    }
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        {
            return StatusCode(500, $"An error occurred while deleting vehicle: {ex.Message}");
        }
    }
}